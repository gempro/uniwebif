    ...
    b.widget("ui.tagit", {
        ...
        _create: function () {
            ...
            this.element.is("input")
                ? ((this.tagList = b("<ul></ul>").insertAfter(this.element)), (this.options.singleField = !0), (this.options.singleFieldNode = this.element), this.element.addClass("tagit-hidden-field"))
            ...
            this.tagList
                ...
                .click(function (d) {
                    var c = b(d.target);
                    c.hasClass("tagit-label") ? ((c = c.closest(".tagit-choice")), c.hasClass("removed") || a._trigger("onTagClicked", d, { tag: c, tagLabel: a.tagLabel(c) })) : a.tagInput.focus();
                });
            var c = !1;
...
//                                ('"' == b.trim(a.tagInput.val()).charAt(0) && '"' == b.trim(a.tagInput.val()).charAt(b.trim(a.tagInput.val()).length - 1) && 0 !== b.trim(a.tagInput.val()).length - 1)))
                    )
                        (c.which === b.ui.keyCode.ENTER && "" === a.tagInput.val()) || c.preventDefault(),
                            (a.options.autocomplete.autoFocus && a.tagInput.data("autocomplete-open")) || (a.tagInput.autocomplete("close"), a.createTag(a._cleanedInput()));
                })
                .blur(function (b) {
        ...
        destroy: function () {
            ...
            this.element.is("input")
                ? (this.element.removeClass("tagit-hidden-field"), this.tagList.remove())
        ...
        assignedTags: function () {
            ...
            this.options.singleField
                ? ((c = b(this.options.singleFieldNode).val().split(this.options.singleFieldDelimiter)), "" === c[0] && (c = []))
        ...
        createTag: function (a, c, d) {
            ...
            !1 !== this._trigger("beforeTagAdded", null, { tag: e, tagLabel: this.tagLabel(e), duringInitialization: d }) &&
                ...
                this._trigger("afterTagAdded", null, { tag: e, tagLabel: this.tagLabel(e), duringInitialization: d }),
                this.options.showAutocompleteOnFocus &&
                    !d &&
                    setTimeout(function () {
                        f._showAutocomplete();
