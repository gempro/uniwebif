...
if ($xml) {
	...
	$sql = mysqli_query($dbmysqli, "INSERT INTO tv_services (e2servicename,servicename_enc,e2servicereference) values ('$e2servicename','$servicename_enc','$e2servicereference')"); }
	}
	}	
	// close db
	...
	<div class=\"col-md-4\">
	<a href=\"$url_format://$box_user:$box_password@$box_ip/web/stream.m3u?ref=$obj->e2servicereference\" title=\"Stream\"><i class=\"fa fa-desktop fa-1x\"></i></a>
	<input id=\"tv_services_zapp_btn_$obj->e2servicereference\" type=\"submit\" onClick=\"tv_services_zapp(this.id)\" value=\"ZAPP TO CHANNEL\" class=\"btn btn-xs btn-default\"/>
