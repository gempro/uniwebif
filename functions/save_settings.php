...
include("../inc/dashboard_config.php");
	...
	$cz_timestamp = strtotime($cz_start) + 86400;
	...
	if ($crawler_am_pm == 'AM'){ $crawler_am_pm = ' AM'; }
	if ($crawler_am_pm == 'PM'){ $crawler_am_pm = ' PM'; }
	...
	$crawler_timestamp = strtotime($crawler_start) + 86400;
	//
