...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div id="page-inner">
      ...
      <div class="row">
        <div class="col-md-4">
          <select id="rec_location" class="form-control">
            <? echo $rec_dropdown_broadcast; ?>
          </select>
        </div>
        <div class="col-md-2">
          <button href="#change_rec_location" class="btn btn-default" onClick="browse_records();" data-toggle="tab">Show records</button>
        </div>
