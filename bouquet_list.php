...
//
	...
	{
	if($obj->crawl == '1'){ $checked_bouquet = 'checked'; }
	
	if($obj->crawl == '0'){ $checked_bouquet = ''; }
	
	if(!isset($bouquet_list) or $bouquet_list == ''){ $bouquet_list = ''; }
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="adjust-nav">
      <div class="navbar-header">
        ...
        <span class="navbar-brand"><span style="font-size:1.1em; color:#000; cursor:pointer;" onclick="remote_modal.open();" title="Remote Control"><i class="fa fa-wifi fa-1x"></i></span> <a class="navbar-link" href="bouquet_list.php">Bouquet list</a></span> </div>
