...
//
	...
	$sql = mysqli_query($dbmysqli, 'SELECT COUNT(id) FROM `timer` WHERE `show_ticker` = "1" AND `e2eventstart` BETWEEN "'.$time.'" AND "'.$ticker_time_end.'" ');
	...
	if($percent_latest < 5 ){ $progressbar2 = '<div class="progress progress-striped">
	...
	$progressbar2 = '<div class="progress progress-striped">
...
function getDatabaseByte($bytes){
	...
	include("inc/dashboard_config.php");
	$sql = mysqli_query($dbmysqli, 'SELECT COUNT(id) FROM `epg_data`');
	$result = mysqli_fetch_row($sql);
...
<body>
<a id="top"></a>
<div id="scroll_top_channelbrowser_list"><a href="#" title="Channelbrowser"><script>document.write ("<i class=\"glyphicon glyphicon-circle-arrow-up fa-"+channelbrowser_btn_size+"x\"></i>");</script></a></div>
<div id="scroll_top_primetime_list"><a href="#" title="Primetime"><script>document.write ("<i class=\"glyphicon glyphicon-circle-arrow-up fa-"+primetime_btn_size+"x\"></i>");</script></a></div>
<div id="scroll_top_broadcast_list"><a href="#" title="Broadcast now"><script>document.write ("<i class=\"glyphicon glyphicon-circle-arrow-up fa-"+broadcast_btn_size+"x\"></i>");</script></a></div>
...
<div id="wrapper">
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="adjust-nav">
      <div class="navbar-header">
        ...
        <span class="navbar-brand"><span style="font-size:1.1em; color:#000; cursor:pointer;" onclick="remote_modal.open();" title="Remote Control"><i class="fa fa-wifi fa-1x"></i></span> <a class="navbar-link" href="dashboard.php">Dashboard</a></span> </div>
  ...
  <div id="statusbar_cnt">&nbsp;</div>
    ...
    <noscript>To use all functions of the website, it's required to activate JavaScript.</noscript>
      ...
      <input id="time_format" type="hidden" value="<?php echo $time_format; ?>">
      <div class="row">
        <div class="col-md-12">
          <h5>Broadcast</h5>
          ...
          <ul class="nav nav-tabs">
            <li>
              <select name="channel_id" id="channel_id" class="form-control">
				...
				{
				// set selected
				if($obj->cb_selected == '1'){ $select = 'selected="selected"'; }
				if($obj->cb_selected == '0'){ $select = ''; }
...
$(function(){
	...
	if (time_format == '1'){ if(isFinite(String(hh)) == false || hh > 23 || hh < 1){ var hh = '00'; $("#broadcast_hh").val("00"); }
	}
	if (time_format == '2') { if(isFinite(String(hh)) == false || hh > 12 || hh < 1){ var hh = '12'; $("#broadcast_hh").val("12"); }
	}
   }
});
});
