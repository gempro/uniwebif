  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="adjust-nav">
      <div class="navbar-header">
        ...
        <span class="navbar-brand"><span style="font-size:1.1em; color:#000; cursor:pointer;" onclick="remote_modal.open();" title="Remote Control"><i class="fa fa-wifi fa-1x"></i></span> <a class="navbar-link" href="crawl_separate.php">Crawler</a></span> </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <select name="channel_id" id="channel_id" class="form-control">
			<?php 
			// channel dropdown
			$sql =  "SELECT * FROM `channel_list` WHERE `e2providername` NOT LIKE 'IPTV;' ORDER BY e2servicename ASC";
